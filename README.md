...
- **Buttons for Claude's permission questions**, a Stop button, and status badges on every conversation (sidebar, title bar, tile headers, chat): Working, Needs you, and Done when Claude finished while you weren't looking (until you open it).
